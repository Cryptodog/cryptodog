    ...
    $(window).ready(function() {
        ...
        */
        ...
        Cryptodog.logout = function() {
            ...
            Cryptodog.xmpp.connection.muc.leave(Cryptodog.me.conversation + '@' + Cryptodog.xmpp.conferenceServer);
        ...
        */
        ...
        var openBuddyMenu = function(nickname) {
            ...
            var ignoreAction = chatWindow[buddy.ignored ? 'unignore' : 'ignore'];
            var $menu = $('#menu-' + buddy.id);
            var $buddy = $('#buddy-' + buddy.id);

...
$(window).ready(function () {
	...
	Cryptodog.xmpp.connect = function () {
		if(typeof Cryptodog.xmpp.currentServer.cleanRelay === "undefined") {
			Cryptodog.xmpp.currentServer.cleanRelay = Cryptodog.xmpp.currentServer.relay;		
		}
		
		Cryptodog.kommy.verifyURL(Cryptodog.xmpp.currentServer.cleanRelay, function (u) {
			Cryptodog.xmpp.currentServer.relay = u;
